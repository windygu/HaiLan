...
namespace HLAWebService
{
    ...
    public class Service1 : System.Web.Services.WebService
    {
        ...
        public bool SIO_EWM_RFID008(string HU, string LOUCENG, string SHIP_DATE, float SHULIANG, string STORE_ID, string XIANGXING, string PICK_TASK)
        {
        ...
        public bool SIO_EWM_RFID010(string HU, string SHIP_DATE)
        {
            HU = !string.IsNullOrEmpty(HU) ? HU.TrimStart('0') : "";
        ...
        {
            return string.Format("吊牌数据:{0} | 物料数据:{1}",
                (Cache.Instance[CacheKey.TAG] as List<HLATagInfo>).Count,
                (Cache.Instance[CacheKey.MATERIAL] as List<MaterialInfo>).Count);
        }


        [WebMethod(Description = "发运箱和下架单关系绑定")]
        public bool SIO_SCD_RFID001(string HU, string LOUCENG, string SHIP_DATE, float SHULIANG, string STORE_ID, string XIANGXING, string PICK_TASK)
        {
            HU = !string.IsNullOrEmpty(HU) ? HU.TrimStart('0') : "";
        ...
        [WebMethod(Description = "发运箱和下架单关系解除绑定")]
        public bool SIO_SCD_RFID002(string HU, string SHIP_DATE)
        {
            HU = !string.IsNullOrEmpty(HU) ? HU.TrimStart('0') : "";
