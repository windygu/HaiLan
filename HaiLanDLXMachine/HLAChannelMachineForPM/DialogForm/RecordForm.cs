...
namespace HLAChannelMachine
{
    public partial class RecordForm : Form
    {
        ...
        public RecordForm(ReceiveType _receiveType)
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            List<ErrorRecord> records = LocalDataService.GetErrorRecordsByHU(hu,start,end,result,docno,SysConfig.Floor, receiveType);
            if (records != null)
            {
                int i = 0;
