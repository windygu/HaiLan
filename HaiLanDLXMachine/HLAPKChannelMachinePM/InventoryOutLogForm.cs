...
*/
        ...
        private void ErrorEpcListWarning(string sEPC, TagDetailInfo dti, int iFlag, bool isrfid)
        {
            ...
            //if (!string.IsNullOrEmpty(sEPC) && !this.ErrorEPCList.Contains(sEPC))
            //{
            //    this.ErrorEPCList.Add(sEPC);

            //    if (!errorLoginForm.Visible)
            //    {
            //        if (iFlag == 0)//物料不存在
            //        {
            //            errorLoginForm.AsynAddCurrentErrorQueue(sEPC, lblOutlog.Text, dti, 0, outLogList);
            //        }
            //        else if (iFlag == 1)
            //        {//物料多拣
            //            errorLoginForm.AsynAddCurrentErrorQueue(sEPC, lblOutlog.Text, dti, 1, outLogList);
            //        }
            //    }
            //    else
            //    {
            //        if (errorLoginForm != null)
            //        {
            //            if (iFlag == 0)//物料不存在
            //            {
            //                errorLoginForm.AsynAddCurrentErrorQueue(sEPC, lblOutlog.Text, null, 0, outLogList);
            //            }
            //            else if (iFlag == 1)
            //            {//物料多拣
            //                errorLoginForm.AsynAddCurrentErrorQueue(sEPC, lblOutlog.Text, dti, 1, outLogList);
        ...
        private bool StartInventory()
        {
            ...
            //        bool isFastSearchEnabled = false;

            //        SimpleReadPlan srpGen2 = new SimpleReadPlan(ant.ToArray(), TagProtocol.GEN2, searchSelect, embTagOp, isFastSearchEnabled);
            ...
            //        }
            //        objCodeTagReaderLib840.SetParam("/reader/read/plan", plan);
            //        simpleReadPlans.Clear();

            //        objCodeTagReaderLib840.SetParam("/reader/read/asyncOnTime", 1000);
            //        objCodeTagReaderLib840.SetParam("/reader/read/asyncOffTime", 0);
            //        //LoadGen2Settings();
            //        objReader.TagRead += r_PrintTagRead;
        ...
        //                    try
        //                    {
        //                        if (objCodeTagReaderLib840.GetServerState(SysConfig.ReaderIp))
        //                        {
        //                            Reader.SetSerialTransport("tcp", SerialTransportTCP.CreateSerialReader);
        //                            string m_Url = "TCP://" + SysConfig.ReaderIp + ":2048";
        //                            objReader = Reader.Create(m_Url);
        //                            objReader.Connect();
        //                            objCodeTagReaderLib840.SetObjReader(ref objReader);
        //                            break;
        //                        }
        //                        else
        //                        {
        ...
        //                    {
        //                        string ErrorMsg = "";
        //                        objCodeTagReaderLib840.GetErrorMsg(ref ErrorMsg);
        //                        MessageBox.Show(ErrorMsg);
        //                    }
        //                    else
        //                    {
        //                        //"射频模块连接失败!"
        //                        MessageBox.Show(m_UserMsgDef._MSG_XDWL_M6E_DEMO_RFMODULE_CONN_FAILURE);
        //                    }
        //                }
        //                else
        //                {
        ...
        //                    m_nCommMode = 1;
        //                    objCodeTagReaderLib840.SetCommMode(m_nCommMode);

        //                    //InitAntenna();
        //                    //InitRegions();
        //                    //SetDevConfigGen2();

        //                    objCodeTagReaderLib840.SetServerIP(SysConfig.ReaderIp);
        //                    this.TcpIsConnectThread = new Thread(new ThreadStart(TcpIsConnect));
        //                    this.TcpIsConnectThread.IsBackground = true;
        //                    this.TcpIsConnectThread.Start();
        //                }
        //            }
        //            catch (Exception re)
        //            {
        ...
        //        catch (Exception re)
        //        {
        //            MessageBox.Show(m_UserMsgDef._MSG_XDWL_M6E_DEMO_NET_CONN_ERROR);
        //            m_bOpen = false;
        //        }
        //    }
        //}
        ...
        //private void r_PrintTagRead(Object sender, TagReadDataEventArgs e)
        //{
        ...
        //    if (!string.IsNullOrEmpty(e.TagReadData.EpcString))
        //        CheckTag(e.TagReadData.EpcString.ToUpper(), true);
        //}
        ...
        //    objCodeTagReaderLib840.GetParam("/reader/version/productGroupID", ref productGroupID);
        //    UInt16 id = (UInt16)productGroupID;
        //    string model = "";
        //    objCodeTagReaderLib840.GetParam("/reader/version/model", ref model);
        //}

        //private void TcpIsConnect()
        //{
        //    int n = 0;
        //    while (m_bOpen)
        //    {
        ...
        //        {
        //            //发送心跳包
        //            //objCodeTagReaderLib840.SendHearMsg();
        //            if (bSendHearMsg)
        //            {
        //                if (!objCodeTagReaderLib840.SendHearMsg())
        //                {
        //                    MessageBox.Show(m_UserMsgDef._MSG_XDWL_M6E_DEMO_NET_CONN_ERROR);
        //                    StopInventory1();
        //                    if (CloseDevice())
        ...
        //    //设置功率
        //    double idBm = 13.0;
        //    int power = Convert.ToInt32(100 * idBm);
        //    int[][] iWritePowerList = { new int[] { 1, power, power, 500 }, new int[] { 2, power, power, 500 }, new int[] { 3, power, power, 500 }, new int[] { 4, power, power, 500 } };
        //    objCodeTagReaderLib840.SetParam("/reader/radio/portReadPowerList", iWritePowerList);
        //}

        //private void InitRegions()
        //{
        //    objCodeTagReaderLib840.SetParam("/reader/region/id", Reader.Region.PRC);
        //}
        //private void SetDevConfigGen2()
        //{
        //    try
        //    {
        //        objCodeTagReaderLib840.SetParam("/reader/gen2/BLF", Gen2.LinkFrequency.LINK250KHZ);
        ...
        //    try
        //    {
        //        objCodeTagReaderLib840.SetParam("/reader/gen2/Tari", Gen2.Tari.TARI_25US);
        //    }
        ...
        //    try
        //    {
        //        objCodeTagReaderLib840.SetParam("/reader/gen2/tagEncoding", Gen2.TagEncoding.M4);
        //    }
        //    catch (Exception re)
        //    {
        ...
        //    try
        //    {
        //        objCodeTagReaderLib840.SetParam("/reader/gen2/session", Gen2.Session.S0);
        //        //objCodeTagReaderLib840.SetParam("/reader/gen2/session", Gen2.Session.S1);
        //    }
        //    catch (Exception re)
        //    {
        ...
        //    try
        //    {
        //        objCodeTagReaderLib840.SetParam("/reader/gen2/target", Gen2.Target.A);
        //        //objCodeTagReaderLib840.SetParam("/reader/gen2/target", Gen2.Target.AB);
        //    }
        //    catch (Exception re)
        //    {
        //    }
        //    try
        //    {
        //        objCodeTagReaderLib840.SetParam("/reader/gen2/q", new Gen2.DynamicQ());
        ...
        private void tmeStop_Tick(object sender, EventArgs e)
        {
            //tmeStop.Enabled = false;
            //if (CloseDevice())
            //{
            //    m_nCommMode = -1;
            //    objCodeTagReaderLib840.SetCommMode(m_nCommMode);
